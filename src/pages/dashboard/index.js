...
import { Row, Col, Breadcrumb, Icon,Layout, Menu, Input,Select,InputNumber, Button,Table,Checkbox} from 'antd';
...
class index extends Component {
        ...
        return(
            <div>
                <div className={styles.top}>
                        <div className={styles.title}>定额库
                        </div>     
                         <Breadcrumb style={{
                         fontSize:"14px",
    ...
    <Breadcrumb.Item style={{  color:"#FDDB28",}} >定额库</Breadcrumb.Item>
                   ...
                   <Row >
                        ...
                        <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }} >
                        <div className={styles.box}>定额库类型:</div> <div className={styles.pox}>
          ...
          <Select defaultValue="请选择" style={{width:"100%",height:"50px"}}>
            ...
            <Option value="data2">Option1-2</Option>
                         ...
                         <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }} >
                        <div className={styles.box}>适用工程:</div> <div className={styles.pox}>
                        <InputGroup size="large" compact style={{height:"50px" , width: '220px'}}>
          <Select defaultValue="请选择" style={{width:"100%",height:"50px"}}>
            <Option value="data1"  >Option1-1</Option>
            <Option value="data2">Option1-2</Option>
                     ...
                     <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }} >
                     <div className={styles.box}>关联项目:</div><div className={styles.pox}>
                     <InputGroup size="large" compact style={{height:"50px" , width: '200px'}}>
       <Select defaultValue="请选择"  style={{width:"100%",height:"50px"}}>
         <Option value="data1">Option1-1zzzzz</Option>
         <Option value="data2">Option1-2</Option>
