      ...
      <div>
        <div className={styles.top}>
          ...
          <Breadcrumb style={{
            ...
            <Breadcrumb.Item href="" style={{ color: "#FFFFFF", marginLeft: "20px", fontSize: "14px" }}>
              <span>首页</span>
            </Breadcrumb.Item  >
        ...
        <div className={styles.content}>
          ...
          <Row >
            <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }} >
              <div className={styles.box}>定额号:</div> <div className={styles.pox}><Input style={{ height: "40px", width: '100%' }} placeholder="请输入" /></div>
            </Col>
          ...
          <ul className={styles.btn}>
            ...
            <li>
              <Button onClick={this.cz} type="primary" htmlType="submit" style={{ backgroundColor: "#237F7E", border: "1px solid #237F7E", height: "80%", width: "100%" }}>
                重置
              </Button>
            </li>
            <li>
