          ...
          >
            ...
            <Row>
              <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <Button style={{ backgroundColor: '#EBFCF0', width: '110px', height: '70px' }}>
                  用户管理
                </Button>
              </Col>
              <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <Button style={{ backgroundColor: '#FFF1F0', width: '110px', height: '70px' }}>
                  修改密码
                </Button>
              </Col>
              <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <Button style={{ backgroundColor: '#E6F7FF', width: '110px', height: '70px' }}>
                  权限修改
                </Button>
              </Col>
            </Row>
            <Row style={{ marginTop: '30px' }}>
              <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <Button style={{ backgroundColor: '#FFFADC', width: '110px', height: '70px' }}>
                  数据字典
                </Button>
              </Col>
              <Col xs={{ span: 11, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <Button style={{ backgroundColor: '#F9FBE5', width: '110px', height: '70px' }}>
                  系统日志
                </Button>
              </Col>
              <Col xs={{ span: 5, offset: 1 }} lg={{ span: 6, offset: 2 }}>
                <Button style={{ backgroundColor: '#E7E7F8', width: '110px', height: '70px' }}>
                  切换用户
                </Button>
              </Col>
            </Row>
