...
import { Row, Col, Breadcrumb, Icon, Layout, Menu, Input, Select, InputNumber, Button, Table, Modal } from 'antd';
...
class index extends Component {
  ...
  render() {
    const { checkState, delState, visible } = this.state
    const rowSelection = {
      onChange: (selectedRowKeys, selectedRows) => {
        // console.log(`selectedRowKeys: ${selectedRowKeys}`, 'selectedRows: ', selectedRows);
      ...
      <div>
        ...
        <div className={styles.content}>
          ...
          <ul className={styles.btn}>
            ...
            <li>
              <Button onClick={this.showModal} type="primary" disabled={delState} htmlType="submit" style={{ backgroundColor: "#237F7E", border: "1px solid #237F7E", height: "80%", width: "100%" }}>
                删除
                            </Button>
            </li>
          </ul>
